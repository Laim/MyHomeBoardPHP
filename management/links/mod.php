<?php
    ...
    if(isset($_GET['action']) && isset($_GET['id']) && isset($_GET['type'])){
        ...
        if(isset($_POST['el_submit'])) {
            ...
            header("location: " . URL . "/management/links/?action=updated&name=" . $db_new_linkname . "&type=link");
            die();
        }
        ...
        if(isset($_POST['eh_submit'])) {
            ...
            header("location: " . URL . "/management/links/?action=updated&name=" . $db_new_hname . "&type=header");
            die();
        }
...
<head>
  ...
  <title>
    <?php print(WebName);?> - Management - Modify
  </title>
