		...
		<div class="row">
			...
			<div class="col-md-6 mb-2">
				<span class="float-right d-none d-md-block">
					<a href="<?php print(URL);?>/management/links/add.php?type=link">Add Link</a>
					<span> - </span>
					<a href="<?php print(URL);?>/management/links/add.php?type=header">Add Header</a>
				</span>
			</div>
		</div>
		<section class="link-sec">
            ...
            <tr>
                ...
                <td class="text-center">
                  <a class="btn btn-primary btn-sm" href="<?php print(URL);?>/management/links/mod.php?id=<?php print($L['LID']);?>&action=edit&type=link">
                    <span class="fas fa-pencil-alt"></span>
                  </a>
        	        <a class="btn btn-primary btn-sm" href="<?php print(URL);?>/management/links/del.php?id=<?php print($L['LID']);?>&action=delete&type=link">
				  ...
				  <table class="table table-bordered" style="background-color: rgb(245, 245, 245);">
                    ...
                    <?php foreach($home->AllHeaders() as $LH) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                            	<a class="btn btn-primary btn-sm" href="<?php print(URL);?>/management/links/mod.php?id=<?php print($LH['HID']);?>&action=edit&type=header">
                                	<span class="fas fa-pencil-alt"></span>
                              </a>
                           		<a class="btn btn-primary btn-sm" href="<?php print(URL);?>/management/links/del.php?id=<?php print($LH['HID']);?>&action=delete&type=header">
                                    <span class="fas fa-trash"></span>
                                </a>
                            </td>
                        </tr>
